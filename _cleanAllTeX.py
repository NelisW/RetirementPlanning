...
#  first parameter defines if the search must be recursively 0=not, 1=recusrive
...
#rather do it by directories, one at a time
#we take the conservative approach and do not do blanket erase, 
...
QueryDelete(1,'.', '*.blg;*.dfn;*.smb;*.bak;*.aux;*.out;*.lot;*.lof;*.toc;*.tex.bak;*.lol;*.dvi;*.efc;*.abr')
